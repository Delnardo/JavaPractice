...
public class ServicioRutina {
    ...
    public void crearRutina(List<Rutina> rutinas) {
        ...
        System.out.println("Teclea la descripcion de como se ejecuta > ");
    ...
    public void actualizarRutina(List<Rutina> rutinas, int id) {
        ...
        if (r.getId() == id) {
            ...
            do {
                ...
                switch (o) {
                    case 'N': r.setNombre(leer.next());break;
                    case 'D': r.setDuracion(leer.nextInt());break;
                    case 'I': r.setNivelDificultad(leer.nextInt());break;
                    case 'E': r.setDescripcion(leer.next());break;
                    case 'S': System.out.println("BYE");break;
